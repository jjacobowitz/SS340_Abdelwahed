...
Note: The order of operations do not match the HW, so Part 1d might come before
part 1a
"""
import numpy as np
import pandas as pd
...
data_describe[important_statistics].to_csv("SS340_HW3_Describe.csv")
print(data_describe)    
...
result = run_regression(data["cigsperday"],
                        ...
                        ylabel=ylabel,
                        title=title,
                        save_title="SS340_HW3_simpleregress.png")
