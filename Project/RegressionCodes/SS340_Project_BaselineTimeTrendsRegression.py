...
Includes county FE and linear time trends

Regression:
    disasters_{i,t} = b0 + b1 tempc_{i,t} + b2 year + a_i + e_{i,t}
"""
import pandas as pd
...
with open('../Results/baseline_regression_with_time_trends_summary.txt',
          'w') as f:
    f.write("Baseline Regression with Time Trends")
    f.write('\n')
